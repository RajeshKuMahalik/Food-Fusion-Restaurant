...
const ReservationFrom = () => {
 ...
 <div className="absolute top-24  left-1/2 transform -translate-x-1/2 max-w-sm p-6 bg-white  rounded-lg shadow-lg sm:top:10 max-750:w-[60vh] max-750:top-[40px] ">
    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <input type="number" name="guests" min="1" className="w-full p-2 border rounded" onChange={handleChange} required />
      <input type="number" name="tableNumber" min="1" className="w-full p-2 border rounded" onChange={handleChange} required />

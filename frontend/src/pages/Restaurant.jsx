                    ...
                    return (
                        ...
                        <div className="max-w-md mx-auto bg-white  rounded-xl mt-10 shadow-md overflow-hidden md:max-w-2xl">
                            ...
                            <div className="p-6">
                                ...
                                <div className={`flex item-center gap-2 text-sm text-center ${item.open ? ' text-green-500' : 'text-gray-500'}`}>
                                    <p className={`w-2 mt-1 h-2 ${item.open ? ' bg-green-500' : 'bg-gray-500'} rounded-full`}></p><p>{item.open ? 'Open' : 'Closed'}</p>
                                </div>

...
const Cart = () => {
  ...
  const { cartItems, food_list, removeFromCart,getCartCountAmount } = useContext(StoreContext)
      ...
      <div className='flex justify-center my-20 '>
        <div className='text-2xl w-[30vw] max-1050:w-[40vw]'>
          ...
          <div className='flex flex-col gap-2 mt-2 text-sm'>
            ...
            <div className='flex justify-between'>
                <b>Total</b>
                <b className='lg:mr-80'>{getCartCountAmount()=== 0 ? 0 : getCartCountAmount()+ randomNum}</b>
            </div>
          </div>
